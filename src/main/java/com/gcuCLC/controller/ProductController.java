...
public class ProductController {
	...
	public String ProductPage(@ModelAttribute("products") ProductModel productClone, BindingResult bindingResult,
			Model model) {
	...
	public String viewOrder(@ModelAttribute Login login, Model model, BindingResult bindingResult) {
		// System.out.println("/viewOrder Order ID: " + orderEntity.getOrderId() + " " +
	...
	public String displayFoundId(@RequestParam(required = false) Integer orderId, Integer id,
			@ModelAttribute("form") OrderEntity form, HttpSession session, Model model, Login login) {
		...
		System.out.println("/editOrder Order ID: " + form.getOrderId() + " " + "Company Name: " + form.getCompanyName()
				+ " " + form.toString());
	...
	public String deleteSingle(@RequestParam(required = false) Integer orderId, Integer id,
			@ModelAttribute("form") OrderEntity form, HttpSession session, Model model, Login login) {
		...
		System.out.println("/removeOrder Order ID: " + form.getOrderId() + " " + "Company Name: "
				+ form.getCompanyName() + " " + form.toString());
		model.addAttribute("orderEntity", form);
		model.addAttribute("orderEntity", ProductController.orderEnt);
		model.addAttribute("login", new Login());
	...
	public String updateOrder(@ModelAttribute Login login, OrderEntity orderEntity, Model model,
			BindingResult bindingResult, Orders orders) {
	...
	public String deleteOrder(@ModelAttribute Login login, OrderEntity orderEntity, Model model,
			BindingResult bindingResult, Orders orders) {
		orderEntity.setOrderId(orderEntity.getOrderId());
		orderEntity.setCompanyName(orderEntity.getCompanyName());
		orderEntity.setCustomerName(orderEntity.getCustomerName());
	...
	public String addOrder(@ModelAttribute Login login, OrderEntity orderEntity, Model model,
			BindingResult bindingResult, Orders orders) {
